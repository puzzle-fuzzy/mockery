...
import { Button } from "@mockery/ui";
import { Input } from "@mockery/ui";
    ...
    <div className="flex min-h-dvh">
      ...
      <div className="hidden w-1/2 flex-col justify-center gap-6 bg-muted p-12 lg:flex">
        ...
        <p className="text-sm text-muted-foreground max-w-sm">
          Upload, version, preview, and publish your static artifacts. A
          lightweight deployment platform for your team.
        </p>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <Button
              ...
              disabled={
                loading || !email || !password || (mode === "register" && !name)
              }
            >
              {loading
                ? "Please wait..."
